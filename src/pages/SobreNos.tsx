...
export const SobreNos = () => {
    ...
    return (
        ...
        <div style={{ paddingTop: '70px'}} >
            ...
            <TextImage altImg={patinhas} image={patinhas} imgSobreNos={imgSobreNos1} altSobreNos={"imagem 1"} isDireita={false} patinhaEsquerda={false}>
            ...
            <TextImage altImg={patinhas} image={patinhas} imgSobreNos={imgSobreNos2} altSobreNos={"imagem 2"} isDireita={true} patinhaEsquerda={true}>
            ...
            <TextImage altImg={patinhas} image={patinhas} imgSobreNos={imgSobreNos3} altSobreNos={"imagem 3"} isDireita={false} patinhaEsquerda={false}>
